...
const DashboardPage = () => {
  ...
  const handleLogout = () => {
    logout(); // reset state ngay
    useAuthStore.persist.clearStorage(); // xóa storage luôn
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside className="fixed top-0 h-screen w-64 bg-gray-900 text-gray-200 flex flex-col">
        <div className="p-6 text-center border-b border-gray-700">
          <h2 className="text-2xl font-bold text-blue-400 mb-2">Admin-BookStore</h2>
      ...
      <div className="flex flex-col flex-1">
        ...
        <header className="flex justify-end items-center gap-6 bg-white border-b h-16 px-6 shadow-sm">
          ...
          >
            ...
            <span className="text-gray-700 font-medium">Clean cache</span>
          </button>

          <button
            onClick={handleLogout}
            className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-red-100 transition cursor-pointer"
          >
